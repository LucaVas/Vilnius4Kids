...
export const googleMapsMapId = import.meta.env.VITE_GOOGLE_MAPS_MAP_ID as string;
...
if (typeof googleMapsMapId !== 'string') throw new Error('VITE_GOOGLE_MAPS_MAP_ID is not defined');
